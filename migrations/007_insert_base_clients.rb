Sequel.migration do
  up do
    self[:clients].insert(:name => 'Nicemondays SCP', :cif => 'J92682345', :address => 'Cno. Antiguo Paso del Ferrocarril Edificio Horizontes, 2 10aA 29640 Fuengirola (Málaga)', :created_at => Time.now)
